...
import {Title} from './HistoryDesign';
import {Content2} from './ReturnCard';

const {width} = Dimensions.get('screen');

//
function AccordionContent({content, contentStyle}) {
  return <Content2 info={content} />;
}
...
export default ReturnAccordion;
